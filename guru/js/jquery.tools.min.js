...
(function (a) {
	...
	function j(a, b, c) {
		var d = a.getDate(), f = a.getDay(), j = a.getMonth(), k = a.getFullYear(), l = {
			d: d,
			dd: g(d),
			ddd: e[c].shortDays[f],
			dddd: e[c].days[f],
		...
		function J(b) {
			b.type = "onShow", C.trigger(b), a(document).bind("keydown.d", function (b) {
				...
				if (a(d).index(e) >= 0) {
					...
					if (e == 74 || e == 40)i += 7; else if (e == 75 || e == 38)i -= 7; else if (e == 76 || e == 39)i += 1; else if (e == 72 || e == 37)i -= 1;
			...
			show: function (d) {
				if (!(c.attr("readonly") || c.attr("disabled") || A)) {
					...
					/iPad/i.test(navigator.userAgent) && (e.top -= a(window).scrollTop()), p.css({
						top: e.top + c.outerHeight({margins: !0}) + g.offset[0],
...
(function (a) {
	a.tools = a.tools || {version: "v1.2.5"}, a.tools.overlay = {
...
(function (a) {
	a.tools = a.tools || {version: "v1.2.5"}, a.tools.tabs = {
		conf: {
			tabs: "a",
			current: "current",
			onBeforeClick: null,
...
(function (a) {
	a.tools = a.tools || {version: "v1.2.5"}, a.tools.tooltip = {
		conf: {
			effect: "toggle",
			fadeOutSpeed: "fast",
			predelay: 0,
