            ...
            <table id="d03"  border="1" width="999">
              ...
              <form name="add" method="post" action="changePassword_process.php" >
                <table width="322" id="password" style="background:#FFFFFF" >
                  <tr bgcolor="#FFFFFF">
                    <td width="166" height="26" valign="top" bgcolor="white" ><strong>&nbsp;Kata Laluan Lama</strong></td>
                    <td width="144" valign="top" bgcolor="white" >&nbsp;
                      <input name="student_matric" type="password" size="10"                               />
                      <input type="hidden" name="student_matric3"  value="<?php echo $row['password'];?>" /></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                    <td height="27" valign="top" bgcolor="white" ><strong>Kata Laluan Baru</strong></td>
                    <td bgcolor="white">&nbsp;
                      <input name="student_name" type="password" size="10"  /></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                    <td height="26" valign="top" bgcolor="white" ><strong>Sahkan Kata laluan</strong></td>
                    <td align="left" valign="top" bgcolor="white">&nbsp;
                      <input name="student_name2" type="password" size="10"  /></td>
                  </tr>
                  <tr bgcolor="#FFFFFF" >
                    <td colspan="2" height="36" valign="top"  bgcolor="white"><input align="center"  name="add2" type="submit" value="SIMPAN" onClick="return Submit()" /></td>
                  </tr>
                </table>
