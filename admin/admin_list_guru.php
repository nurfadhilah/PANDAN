...
?>
                ...
                <center>
                  ...
                  <tr>
                   ...
                   <td background-color="#99CC33"><a href="admin_view_guru.php?id=<?php echo $ic; ?>"><?php echo $ic; ?></a></td>
        
                    <td bgcolor="#CC0033"><?php echo $Name; ?></td>
                    <td bgcolor="#CC0033"><?php echo $notelefon; ?></td>
                    <td bgcolor="#CC0033"><a href="admin_drop_teacher.php?id=<?php echo $lec_id; ?>"><input type="reset" name="input2" class="reset" value="PADAM" /></a></td>
